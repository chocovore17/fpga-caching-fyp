...
vlog -work work +acc=blnr -noincr -timescale 1ns/1ps testbench/unit_level/UPDOWNSTREAM/tb_top_UPDOWNSTREAM.sv shared/top.sv
vopt -work work tb_top_UPDOWNSTREAM  -o seg_work_opt
vsim -coverage seg_work_opt -c -logfile testbench/outputs/top/UPDOWNSTREAMnoreset_sim.txt  -do "run -all; coverage report -file testbench/outputs/top/UPDOWNSTREAMnoreset_cov_report.txt -byfile -assert -directive -cvg -codeAll; coverage save -onexit -assert -directive -cvg -codeAll testbench/outputs/top/updown.ucdb; quit"
